...
### `build(decision:, vectors: = [], limits: = {})` <a id="method-c-build"></a> <a id="build-class_method"></a>
...
### `overlay(decision_id:, rules:, vectors:)` <a id="method-c-overlay"></a> <a id="overlay-class_method"></a>
Not documented.
...
### `rule(decision_id, conditions, path, index)` <a id="method-c-rule"></a> <a id="rule-class_method"></a>
Not documented.
...
### `static_reachability(conditions, values)` <a id="method-c-static_reachability"></a> <a id="static_reachability-class_method"></a>
Conservative static reachability: prove impossibility, or answer unknown.

### `summary(decision_id:, rules:, diagnostics:)` <a id="method-c-summary"></a> <a id="summary-class_method"></a>
Not documented.
